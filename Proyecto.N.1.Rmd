...
###### **Estado_Siniestro vs Puntaje_Morosidad1*
...
### **4. No Paramétrica: Prueba de Wilcoxon para 2 muestras relacionadas**
Ho: La mediana de las diferencias de cada par de datos es cero.
Ha: La mediana de las diferencias de cada par de datos es diferente de cero.

#### **Deseamos comprobar si la mediana de las diferencias del Número de Siniestros en el 1er Periodo y 2do Periodo es diferente de cero.**
